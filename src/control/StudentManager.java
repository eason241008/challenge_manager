...
public class StudentManager {
    ...
    public boolean addStudent(Beanstudent student) {
        ...
        try (Connection con = DBUtil.getConnection();
            ...
            pstmt.setDate(3, new Date(student.getEnrollmentYear().getTime()));
    ...
    public boolean updateStudent(Beanstudent student) {
        ...
        try (Connection con = DBUtil.getConnection();
            ...
            pstmt.setDate(2, new Date(student.getEnrollmentYear().getTime()));
        ...
        try (Connection con = DBUtil.getConnection();
            ...
            try (ResultSet rs = pstmt.executeQuery()) {
                if (rs.next()) {
                    ...
                    student.setEnrollmentYear(rs.getDate("Enrollment_year"));
